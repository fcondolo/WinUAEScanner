...
customReg.Add(0x044, " BLTAFWM Blitter first word mask for source A");
        ...
        byte getByte(byte[] _data, ref int _index)
        {
            return _data[_index++];
        }

        ushort  getWord(byte[] _data, ref int _index)
        {
        ...
        uint getLong(byte[] _data, ref int _index)
        {
        ...
        void dumpCopper(ref int readIndex)
        {
        ...
        void fillData()
        {
            ...
            {
                int offset = getWord(data, ref readIndex);
